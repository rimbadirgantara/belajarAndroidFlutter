...
import 'package:aplikasi_absen/model/log_activity.dart';
import 'package:aplikasi_absen/screen//log_activity_screen/add_log_screen.dart';
import 'package:aplikasi_absen/screen//log_activity_screen/update_log_screen.dart';
...
class _ActivityLogsScreenState extends State<LogsActivityScreen> {
  ...
  void _addLog() {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) =>
            AddLogScreen(token: widget.token, nik: widget.nik),
      ),
    ).then((value) {
      if (value == true) {
        setState(() {
